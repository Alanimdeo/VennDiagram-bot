        ...
        if (guildQueue) {
            ...
            if (!/^[0-9:.]+$/.test(interaction.options.getString("시간"))) {
                ...
                if (seekTime > 59999) {
                    if (seekTime > 3599999)
                        displayTime =
                            parseInt(seekTime / 3600000) +
                            ":" +
                            parseInt((seekTime % 3600000) / 60000)
                                .toString()
                                .padStart(2, "0") +
                            ":" +
                            parseInt(((seekTime % 3600000) % 60000) / 1000)
                                .toString()
                                .padStart(2, "0");
                    else
                        displayTime =
                            parseInt(seekTime / 60000) +
                            ":" +
                            parseInt((seekTime % 60000) / 1000)
                                .toString()
                                .padStart(2, "0");
                } else
                    displayTime =
                        "0:" +
                        parseInt(seekTime / 1000)
                            .toString()
                            .padStart(2, "0");
            }
