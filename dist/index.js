...
const adminCommandFiles = fs.readdirSync("./adminCommands").filter((file) => file.endsWith(".js") || file.endsWith(".ts"));
...
client.on("messageCreate", (message) => __awaiter(void 0, void 0, void 0, function* () {
    if (message.author.bot)
        return;
    if (!message.content.toLowerCase().startsWith(config.adminPrefix + "admin") || !config.adminIDs.includes(message.author.id))
        return;
