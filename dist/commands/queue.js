...
var Song = require("discord-music-player").Song;
module.exports = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        message_1 = ":scroll: 재생 목록\n";
                        guildQueue.songs.forEach(function (song, index, array) {
                            message_1 += "\n`[" + String(index + 1).padStart(String(array.length).length, "0") + "]`: **" + song.name + "** `(" + song.duration + ")`";
                        });
                        message_1 += "\n\n\uCD1D \uACE1 \uC218: **" + guildQueue.songs.length + "**\uACE1, \uC7AC\uC0DD \uC2DC\uAC04: **?**";
                        return [4 /*yield*/, interaction.editReply(message_1)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
