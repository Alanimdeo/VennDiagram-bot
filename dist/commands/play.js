...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var guildQueue, queue_1, song, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!interaction.options.getString("제목")) return [3 /*break*/, 5];
                        queue_1 = interaction.client.player.createQueue(interaction.guildId);
                        return [4 /*yield*/, queue_1.join(interaction.member.voice.channel)];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 13];
                    case 5:
                        if (!guildQueue) return [3 /*break*/, 11];
                        _a.label = 6;
                    case 6:
                        _a.trys.push([6, 8, , 10]);
                    ...
                    case 11: return [4 /*yield*/, interaction.editReply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    .setColor("#ff0000")
                                    .setTitle(":warning: 오류")
