        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        if (!interaction.options.getNumber("시간")) return [3 /*break*/, 7];
                        return [4 /*yield*/, sleep(interaction.options.getNumber("시간") * 1000)];
                    case 5:
                        _a.sent();
                        if (!(guildQueue.paused == true)) return [3 /*break*/, 7];
