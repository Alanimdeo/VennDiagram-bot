...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var guildQueue, seekTime, displayTime, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!guildQueue) return [3 /*break*/, 6];
                        seekTime = 0;
                        displayTime = "";
                        if (!!/^[0-9:.]+$/.test(interaction.options.getString("시간"))) return [3 /*break*/, 3];
                        return [4 /*yield*/, interaction.editReply()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        if (interaction.options.getString("시간").includes(":")) {
                            input = interaction.options.getString("시간").split(":");
                    ...
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, interaction.editReply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    .setColor("#ff0000")
                                    .setTitle(":warning: 오류")
